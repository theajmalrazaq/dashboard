...
export const GET: APIRoute = async () => {
  ...
  try {
    ...
    const response = await fetch(
      `https://github.com/theajmalrazaq.private.atom?token=${token}`,
    );
