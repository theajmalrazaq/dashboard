...
export default function DashboardModal({
  ...
  return (
    <div
      className={`fixed inset-0 ${zIndex} flex items-center justify-center bg-black/80 backdrop-blur-md p-4 animate-in fade-in duration-300`}
    >
      ...
      >
        {!hideHeader && (
          <div className="flex items-start justify-between">
            <div>
              {title && (
                <h3 className="text-lg font-bold text-gray-900 dark:text-gray-100 font-product-sans lowercase">
                  {title}
                </h3>
              )}
              {subtitle && (
